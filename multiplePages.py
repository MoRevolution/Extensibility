...
class tapStrapGUI:
    ...
    def featureButtons(self):
        ...
        self.button1 = Button(self.frame1, text = "Feature #1",
        ...
        self.button2 = Button(self.frame1, text = "Feature #2",
        font = ('Courier New', 15), fg= "White", bd = 0, bg = "#0d0d0d",
        ...
        self.button3 = Button(self.frame1, text = "Feature #3",
        font = ('Courier New', 15), fg= "White", bd = 0, bg = "#0d0d0d",
    ...
    def triggerFeat2(self, labelTxt):
         ...
         width = 400,bg = "black")
         self.mainCanvas.pack(pady = 50)
         self.backgroundImg = Image.open('mona1.PNG')
         self.tempImg = self.backgroundImg
         print(self.backgroundImg.mode)
         resized = self.backgroundImg.resize((200, 200), Image.LANCZOS)
         self.imageX = ImageTk.PhotoImage(resized)
         ...
         self.buttonTemp4 = Button(master = self.mainFrame, text = "Change Hue?", command = lambda : self.pillowContBlur2(resized, self.mainCanvas))
    ...
    def triggerFeat3(self, labelTxt):
         ...
         font = ("Courier New", 18), relief = RAISED, bg = "#0d0d0d",
         fg = '#fff')
         self.label3A.grid(row = 0, column = 1,pady = 100)
         self.t1A = Text(self.frameF3,  height = 5, width = 20, bd= 5, relief=SUNKEN, fg = "Blue")
         self.t1A.grid(row = 1, column = 0, padx = 25)
         self.t2A = Text(self.frameF3, height = 5, width = 20, bd= 5, relief=SUNKEN, fg = "Blue")
         self.t2A.grid(row = 1, column = 1, padx = 25)
         self.t3A = Text(self.frameF3, height = 5, width = 20, bd= 5, relief=SUNKEN, fg = "Blue")
         self.t3A.grid(row = 1, column = 2, padx = 25)
    ...
    def pillowContBlur(self, image1, canvas):
        ...
        for j in reversed(range(0,30)):
            ...
            time.sleep(.03)
        #    print(j)
        # ADD FUNCTIONALITYYYY

    def pillowContBlur2(self, image1, canvas):
        #Increase Gaussian Blur
    ...
    def pillowHueCommand(self, iamge1, canvas):
        pass
